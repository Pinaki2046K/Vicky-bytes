    ...
    <section className="relative overflow-hidden border-b border-white/5 py-16 md:py-20">
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(rgba(255,61,48,0.07) 1px, transparent 1px), linear-gradient(90deg, rgba(255,61,48,0.07) 1px, transparent 1px)",
        ...
        {[
          ...
          <div
            key={i}
            className={`absolute w-5 h-5 ${cls} border-brand-500/25`}
          />
        ))}
      </div>
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="space-y-1 fade-up-2">
              <h1
                ...
                style={{
                  textShadow:
                    "0.02em 0 0 rgba(255,61,48,0.35), -0.02em 0 0 rgba(0,200,255,0.15)",
                }}
              >
                {line1}
              </h1>
              <h1
                ...
                style={{
                  textShadow:
                    "0.03em 0 0 rgba(0,200,255,0.25), -0.03em 0 0 rgba(255,61,48,0.15)",
                }}
              >
                {line2}
              </h1>
            ...
            <p className="text-sm sm:text-base text-ink-muted leading-relaxed max-w-lg fade-up-3 border-l-2 border-brand-500/40 pl-4">
              Music festivals, esports championships, tech keynotes, and live
              conversations — all in one place, all in real time.
            </p>
            ...
            <div className="flex flex-wrap gap-3 fade-up-4">
              <Link
                ...
                style={{
                  ...
                  boxShadow:
                    "0 0 20px rgba(255,61,48,0.25), inset 0 1px 0 rgba(255,255,255,0.1)",
                }}
              >
            ...
            <div className="flex flex-wrap fade-up-5">
              {[
                ...
                >
                  ...
                  <div className="font-mono text-xl font-black text-ink leading-none">
                    {value}
                  </div>
                  <div className="font-mono text-[9px] text-ink-faint tracking-[0.15em] mt-1">
                    {label}
                  </div>
                </div>
              ))}
            ...
            <div style={{ perspective: "900px" }}>
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    "0 0 0 1px rgba(255,255,255,0.03), 0 50px 100px rgba(0,0,0,0.7), 0 0 50px rgba(255,61,48,0.05), inset 0 1px 0 rgba(255,255,255,0.05)",
                  ...
                  <div className="absolute inset-0 p-3 flex flex-col justify-between">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-1.5 px-2 py-1 rounded-sm bg-black/50 border border-white/10">
                        <span className="w-1.5 h-1.5 rounded-full bg-brand-500 animate-pulse-dot" />
                        <span className="font-mono text-[9px] text-brand-400 tracking-widest">
                          LIVE
                        </span>
                      </div>
                    ...
                    <div>
                      <div className="inline-block px-2 py-0.5 rounded-sm bg-black/50 border border-white/10 mb-2">
                        <span className="font-mono text-[8px] text-ink-muted tracking-widest">
                          {featured.category.toUpperCase()}
                        </span>
                      </div>
                      <p
                        className="font-mono text-xs font-bold text-ink leading-snug line-clamp-2"
                ...
                <div className="flex items-center justify-between px-1 py-2.5 border-t border-white/5 mt-2">
                  <div className="flex items-center gap-2">
                    <div
                      ...
                      style={{ boxShadow: "0 0 6px #ff3d30" }}
                    />
                    <span className="font-mono text-[9px] text-ink-faint tracking-widest">
                      VICKYBYTES LIVE
                    </span>
                  </div>
                  <div className="flex gap-1 items-end">
                    {[...Array(5)].map((_, i) => (
                      <div
                        key={i}
                        className={`w-1 rounded-sm ${i < 3 ? "bg-brand-500" : "bg-surface-4"}`}
                        style={{ height: i < 3 ? "12px" : "8px" }}
                      />
                    ))}
                  </div>
                </div>
